...
@section('screen-sub', 'Edit profile — avatar, giới thiệu, thành tích')
...
<form method="POST" action="{{ route('profile.update') }}" enctype="multipart/form-data"
    ...
    <div style="display: flex; flex-direction: column; gap: var(--space-4)">
        ...
        <label class="field">
            <span class="label-up">Giới thiệu · Bio</span>
        ...
        <label class="field">
            <span class="label-up">Nơi ở · Location</span>
            <input class="input" name="location" value="{{ old('location', $user->location) }}" placeholder="Hà Nội">
        </label>

        <label class="field">
            <span class="label-up">Thành tích · Achievements</span>
        ...
        <div style="display: flex; gap: var(--space-3); align-items: center">
            <button type="submit" class="btn btn-primary" style="font-size: 13px">Lưu hồ sơ · Save</button>
