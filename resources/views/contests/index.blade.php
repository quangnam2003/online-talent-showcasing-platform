        ...
        <section style="display: flex; flex-direction: column; gap: var(--space-3)">
            ...
            <div class="grid-2">
                @foreach ($contests as $contest)
                    <a class="card" href="{{ route('contests.show', $contest) }}" style="padding: var(--space-4); gap: var(--space-2); text-decoration: none; color: inherit">
                        ...
                        <span style="font-family: var(--font-heading); font-weight: 400; font-size: 24px; line-height: 1.15">{{ $contest->title }}</span>
